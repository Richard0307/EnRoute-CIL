...
def create_args():
    ...
    parser.add_argument('--seed', type=int, default=0, help='Base random seed for the current run')
    parser.add_argument('--class_order_path', type=str, default='', help='Optional class-order json/yaml file')
